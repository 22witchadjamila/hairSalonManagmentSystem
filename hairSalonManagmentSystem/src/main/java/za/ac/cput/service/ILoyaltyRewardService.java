...
public interface ILoyaltyRewardService {
    /** Returns the customer's loyalty reward, creating a fresh BRONZE one
    ...
    /** Redeems points from the balance (does not affect tier, which is based
     * on lifetime earned points)*/
